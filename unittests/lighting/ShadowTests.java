...
public class ShadowTests {
   ...
   private final Camera.Builder camera     = Camera.getBuilder()
      .setDirection(new Vector(0,0,0), new Vector(0,1,0))
   ...
   private final Material       trMaterial = new Material().setKD(0.5).setKS(0.5).setKS(30);
   ...
   private void sphereTriangleHelper(String pictName, Triangle triangle, Point spotLocation) {
      ...
      scene.lights.add( //
                       new SpotLight(spotLocation, new Color(400, 240, 0),  new Vector(1, 1, -3)) //
                          .setKL(1E-5).setKQ(1.5E-7));
      Camera c = camera.setImageWriter(new ImageWriter(pictName, 400, 400))
         .build();
         c.renderImage(); //
         c.writeToImage();
   }
   ...
   public void trianglesSphere() {
      ...
      scene.lights.add(
                       new SpotLight(new Point(40, 40, 115), new Color(700, 400, 400),  new Vector(-1, -1, -4)) //
                          .setKL(4E-4).setKQ(2E-5));

      Camera c = camera.setImageWriter(new ImageWriter("shadowTrianglesSphere", 600, 600))
         .build();
         c.renderImage();
         c.writeToImage();
   }
